...
@pytest.mark.parametrize('currency_name, number, transactions, result',
                         [("USD", 2,
                           [{"id": 939719570,
...
@pytest.mark.parametrize('number, transactions, result',
                         [(2,
                           [{"id": 939719570, "description": "Перевод организации",
                             "operationAmount": {"amount": "9824.07", "currency": {"name": "USD", "code": "USD"}}, },
                            {"id": 142264268, "description": "Перевод со счета на счет",
                             "operationAmount": {"amount": "7914.93", "currency": {"name": "RUB", "code": "RUB"}}, },
                            {"id": 142264268, "description": "Перевод с карты на карту",
                             "operationAmount": {"amount": "7914.93", "currency": {"name": "USD", "code": "USD"}}, }],
                           ["Перевод организации", "Перевод со счета на счет"]),
                          (3,
                           [{"id": 939719570, "description": "Перевод с карты на карту",
                             "operationAmount": {"amount": "9824.07", "currency": {"name": "USD", "code": "USD"}}, },
                            {"id": 123987645, "description": "Перевод со счета на счет",
                             "operationAmount": {"amount": "2345.67", "currency": {"name": "RUB", "code": "RUB"}}, },
                            {"id": 142264268, "description": "Перевод организации",
                             "operationAmount": {"amount": "7914.93", "currency": {"name": "RUB", "code": "RUB"}}, }],
...
@pytest.mark.parametrize('start, end, result',
                         [(1, 5, ["0000 0000 0000 0001", "0000 0000 0000 0002", "0000 0000 0000 0003",
                          ...
                          (357, 362, ["0000 0000 0000 0357", "0000 0000 0000 0358", "0000 0000 0000 0359",
                                      "0000 0000 0000 0360", "0000 0000 0000 0361", "0000 0000 0000 0362"]),
                          (999, 1000, ["0000 0000 0000 0999", "0000 0000 0000 1000"]),
                          (1234567888, 1234567890, ["0000 0012 3456 7888", "0000 0012 3456 7889",
                                                    "0000 0012 3456 7890"])])
